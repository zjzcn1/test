...
public class HttpClient {
    ...
    public HttpClient(String baseUrl) {
        this(baseUrl, DEFAULT_CONNECT_TIMEOUT_SECONDS, DEFAULT_READ_TIMEOUT_SECONDS, DEFAULT_WRITE_TIMEOUT_SECONDS);
    }

    public HttpClient(String baseUrl, int connectTimeout, int readTimeout, int writeTimeout) {
