...
public strictfp class S2Test extends GeometryTestCase {
    ...
    public void testAngleArea() {
        ...
        LOG.info("Worst case Girard for triangle area 1e-30: " + maxGirard);
    ...
    private void lessOrEqual(MetricBundle a, MetricBundle b) {
    ...
    public void testMetrics() {
        ...
        lessOrEqual(width, angleSpan);
        lessOrEqual(width, edge);
        lessOrEqual(edge, diag);
