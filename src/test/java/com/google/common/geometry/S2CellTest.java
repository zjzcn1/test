...
public strictfp class S2CellTest extends GeometryTestCase {
    ...
    private void subdivide(S2Cell cell) {
        gatherStats(cell);
        if (cell.isLeaf()) {
            return;
        }
    ...
    public void testSubdivide() {
        for (int face = 0; face < 6; ++face) {
            subdivide(S2Cell.fromFacePosLevel(face, (byte) 0, 0));
        }
