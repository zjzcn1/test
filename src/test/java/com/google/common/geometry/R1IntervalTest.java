...
public strictfp class R1IntervalTest extends GeometryTestCase {
     ...
     */
    void intervalOps(R1Interval x, R1Interval y, String expectedRelation) {
    ...
    public void testBasic() {
        ...
        intervalOps(empty, empty, "TTFF");
        intervalOps(empty, unit, "FFFF");
        intervalOps(unit, half, "TTTT");
        intervalOps(unit, unit, "TFTT");
        intervalOps(unit, empty, "TTFF");
        intervalOps(unit, negunit, "FFTF");
        intervalOps(unit, new R1Interval(0, 0.5), "TFTT");
        intervalOps(half, new R1Interval(0, 0.5), "FFTF");
