...
public strictfp class S1AngleTest {
    ...
    public void testBasic() {
        ...
        assertEquals(S1Angle.radians(Math.PI).radians(), Math.PI, EPSILON);
        assertEquals(S1Angle.radians(Math.PI).degrees(), 180.0, EPSILON);
        assertEquals(S1Angle.degrees(180).radians(), Math.PI, EPSILON);
        assertEquals(S1Angle.degrees(180).degrees(), 180.0, EPSILON);

        assertEquals(S1Angle.radians(Math.PI / 2).degrees(), 90.0, EPSILON);

        // Check negative angles.
        assertEquals(S1Angle.radians(-Math.PI / 2).degrees(), -90.0, EPSILON);
        assertEquals(S1Angle.degrees(-45).radians(), -Math.PI / 4, EPSILON);
